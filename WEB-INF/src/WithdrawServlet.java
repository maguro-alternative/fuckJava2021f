...
public class WithdrawServlet extends HttpServlet {
    public void doGet(HttpServletRequest request,
        ...
        pw.println("    引き出しする口座の名前と金額を入力してください。<br>");
        pw.println("    <form action="+"bank"+" method="+"GET"+">");     //BankServletのdoGetへ送信
        pw.println("        <input type="+"hidden"+" name="+"command"+" value="+"withdraw"+">");    //command=withdraw
        pw.println("        名前：<input type="+"text"+" name="+"name"+" size="+"40"+" /><br>");    //name=口座名
        pw.println("        金額：<input type="+"text"+" name="+"amount"+" size="+"40"+"><br>");    //引き出し額

...
public class CloseServlet extends HttpServlet {
    public void doGet(HttpServletRequest request,
        ...
        pw.println("    解約する口座の名前を入力してください。<br>");
        pw.println("    <form action="+"bank"+" method="+"GET"+">");     //BankServletのdoGetへ送信
        pw.println("        <input type="+"hidden"+" name="+"command"+" value="+"close"+">");       //command=close
        ...
        //pw.println("                    <li class="+"nav-item"+"><a href="+"close-success.html"+">決定</a></li>");

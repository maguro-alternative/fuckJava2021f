...
public class BalanceServlet extends HttpServlet {
    public void doGet(HttpServletRequest request,
        ...
        pw.println("    残高をみる口座の名前を入力してください。<br>");
        pw.println("    <form action="+"bank"+" method="+"GET"+">");     //BankServletのdoGetへ送信
        pw.println("        <input type="+"hidden"+" name="+"command"+" value="+"balance"+">");     //command=balance
        ...
        //pw.println("                    <li class="+"nav-item"+"><a href="+"balance-success.html"+">決定</a></li>");
